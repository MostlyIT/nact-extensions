...
const test = () => !(global as any).process?.browser && global && "setImmediate" in global && typeof global.setImmediate === 'function';

const install = (func: (deadline: Deadline) => any) => () => (global as any).setImmediate(() => func(new Deadline()));
